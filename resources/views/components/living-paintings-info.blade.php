<x-two-columns style="align-items:start;margin-top:5.5rem;">
  ...
  <p>Seansi notiek no 12.00 līdz 19.30 <strong style="color: #9E004F; font-size: 1.2rem">no otrdienas līdz svētdienai</strong>.</p>
  <ul>
  ...
  <x-slot:second_slot>
    ...
    <ul style="padding-left: 20px">
      <li style="margin-bottom: 0; list-style-type: disc">bērniem līdz 2 gadu vecumam,</li>
